        ...
        <div class="container">
            <div class="page_sidebar">
                <ul class="page_nav">
                    ...
                    <li><a class="nav_item active" href="/iaar/{{\App\Models\StaticPage::where('type_id',21)->first()->slug}}/{{$lang}}">{{\App\Models\StaticPage::where('type_id',21)->first()->getLocaleNode($lang)->title}}</a></li>
            ...
            <div class="structure_block">
                ...
                <div class="partner-area partner-area--2">
                @foreach(\App\Models\MainPartner::orderBy('sort_order')->where('is_international',TRUE)->get() as $document)
                    <a href="/partner/{{$document->slug}}/{{$lang}}" class="mezh_partner_block">                            
                        ...
                        <div class="partner-text">{!!  $document->getLocaleNode($lang)->text !!}</div>
                    </a>
                @endforeach
                </div>
            </div>
