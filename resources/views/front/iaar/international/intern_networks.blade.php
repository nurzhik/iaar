    ...
    <div class="page">
        <div class="container">
            <div class="page_sidebar">
                <ul class="page_nav">
                    <li><a class="nav_item active"  href="/iaar/{{\App\Models\StaticPage::where('type_id',20)->first()->slug}}/{{$lang}}">{{\App\Models\StaticPage::where('type_id',20)->first()->getLocaleNode($lang)->title}}</a></li>
                ...
                <div class="page_news">
                    ...
                    <div class="page_news_slider">
                        @foreach($news as $article)
                            <div class="news_item">
                                <a href="/news/{{$article->slug}}/{{$lang}}" style="background: url('{{asset($article->main_image)}}') center / cover no-repeat;" class="news_img" ></a>
                                <div class="news_text">
