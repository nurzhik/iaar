        ...
        <div class="container">
            <div class="page_sidebar">
                <ul class="page_nav">                    
                    ...
                    <li><a class="nav_item active" href="/reports/{{\App\Models\StaticPage::where('type_id',26)->first()->slug}}/{{$lang}}">{{\App\Models\StaticPage::where('type_id',26)->first()->getLocaleNode($lang)->title}} </a></li>
            ...
            <div class="expert">
                ...
                <div class="static-info">
                    @if(strlen($item->main_image))
                        <div class="expert_img" style="background-image: url('{{$item->main_image}}');"></div>
                    @endif
