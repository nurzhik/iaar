        ...
        <div class="container">
            <div class="page_sidebar">
                <ul class="page_nav">
                    ...
                    <li><a class="nav_item active" href="/reports/{{\App\Models\StaticPage::where('type_id',28)->first()->slug}}/{{$lang}}">{{\App\Models\StaticPage::where('type_id',28)->first()->getLocaleNode($lang)->title}} </a></li>
