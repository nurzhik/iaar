...
@section('content')
    ...
    <div class="blank-page">
        <h2 class="title1">
            @if(empty($item->id))
                Добавление возможного направления к эксперту {{$parent->name}}
            @else
                Редактирование возможного направления эксперта  {{$parent->name}}
            @endif
        </h2>
        <form method="post"  @if(empty($item->id))action="/admin/experts/possible-dir/{{$parent->id}}/create" @else action="/admin/experts/possible-dir/{{$parent->id}}/{{$item->id}}" @endif>
            {{csrf_field()}}
            <div class="blank-page">
                @if (session('status'))
                ...
                <div id="myTabContent" class="tab-content scrollbar1">
                    <div role="tabpanel" class="tab-pane fade active in" id="main" aria-labelledby="main-tab">
                        ...
                        <div class="bordered-dir " id="existing_directions">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label data-id="1" for="existing_dirs_1_direction_id">Направлениеz:</label>
