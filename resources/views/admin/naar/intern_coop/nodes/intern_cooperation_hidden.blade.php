...
@section('content')
    ...
    <div class="main-page">
        <h2 class="title1">
            ...
            Редактирование скрытой страницы раздела "Международное сотрудничество" на язык {{$lang}}

        </h2>
        <form method="post" action="/admin/naar/int/nodes/intern_cooperation_hidden/{{$item->lang}}" >
            {{csrf_field()}}
