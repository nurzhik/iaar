...
@section('content')
    ...
    <div class="blank-page">
        <h2 class="title1">
            @if(empty($item->id))
                Добавление институциональной аккредитации к университету "{{$parent->title}}"
            @else
                Редактирование институциональной аккредитации университета "{{$parent->title}}"
            @endif
        </h2>
            ...
            <div class="blank-page">
                ...
                <div id="myTabContent" class="tab-content scrollbar1">
                    <div role="tabpanel" class="tab-pane fade active in" id="main" aria-labelledby="main-tab">
                        ...
                        <div class="form-group">
                            <label for="ex_ante">Является ex-ante?</label>
                    ...
                    <div role="tabpanel" class="tab-pane fade  in" id="deqar" aria-labelledby="main-tab">
                        ...
                        <a style="display:block;margin-bottom:22px;" href="{{route('send_deqar_main',['item' => $item->id])}}"> <button type="button" class="btn btn-pri btn-success"><i class="fa " aria-hidden="true"></i>Отправить аккредитацию в DEQAR</button>   </a>
                        <div class="form-group">
                    ...
                    @if(!empty($item->id))
                        <div role="tabpanel" class="tab-pane fade in" id="translations" aria-labelledby="translations-tab">
                            ...
                            @if(!($item->nodes()->where('lang','kz')->exists()))
                                <a style="display:block;margin-bottom:22px;" href="{{route('create_main_accr_node',['lang' =>'kz','parent' => $item->id])}}"> <button type="button" class="btn btn-pri btn-success"><i class="fa fa-plus" aria-hidden="true"></i>Добавить перевод на казахский язык </button></a>
                            @endif
                            @if(!($item->nodes()->where('lang','en')->exists()))
                                <a style="display:block;margin-bottom:22px;" href="{{route('create_main_accr_node',['lang' =>'en','parent' => $item->id])}}"> <button type="button" class="btn btn-pri btn-success"><i class="fa fa-plus" aria-hidden="true"></i>Добавить перевод на английский язык </button></a>
                            @endif
