                ...
                <div id="myTabContent" class="tab-content scrollbar1">
                    <div role="tabpanel" class="tab-pane fade active in" id="main" aria-labelledby="main-tab">
                        ...
                        <div class="form-group">
                            <label for="main_image">Главная картинка 2</label>
                            <div class="input-group">
                                <span class="input-group-btn">
                                  <a data-inputid="feature_image" data-preview="main_image_preview" class="btn btn-primary popup_selector">
                                     <i class="fa fa-picture-o"></i> Выберите картинку
                                    </a>
                                </span>
                                <input readonly="readonly" id="feature_image" class="form-control" type="text" value="{{$item->main_image}}" name="main_image">
                            </div>
