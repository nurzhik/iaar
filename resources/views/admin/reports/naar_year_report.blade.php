...
@section('content')
    <script type="text/javascript">
        $(document).ready(function(){
            $('.delete_main_accr').on('click',function(){
                ...
                $('#delete_attachment_form').attr('action','/admin/reports/11/attachment/{{$item->id}}/delete/'+item_id);
    ...
    <div class="main-page">
        <h2 class="title">
            Редактирование страницы ежегодных отчетов НААР
        </h2>
        <form method="post" action="/admin/reports/11/edit" >
            {{csrf_field()}}
            <div class="blank-page">
                ...
                <div id="myTabContent" class="tab-content scrollbar1">
                    ...
                    <div role="tabpanel" class="tab-pane fade " id="add_documents" aria-labelledby="add_documents-tab">
                        ...
                        <hr>
                        <div >
                            <a style="display:block;margin-bottom:22px;" href="{{route('create_attachment',['parent' => $item,'type' => 11])}}"> <button type="button" class="btn btn-pri btn-success"><i class="fa fa-plus" aria-hidden="true"></i>Добавить вложение </button></a>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($item->attachments()->orderBy('sort_order')->get() as $attachment)
                                        <tr class="success">
                                            ...
                                            <td><a href="{{route('edit_attachment',['parent' => $item,'item'=>$attachment->id,'type'=>11])}}"><i class="glyphicon glyphicon-edit"></i></a><a class="delete_main_accr" data-toggle="modal" data-target="#delete-element-modal"  itemid="{{$attachment->id}}" href="#"><i class="glyphicon glyphicon-remove"></i></a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
