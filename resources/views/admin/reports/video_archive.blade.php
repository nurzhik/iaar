...
@section('content')
    <script type="text/javascript">
        $(document).ready(function(){
            $('.delete_main_accr').on('click',function(){
                ...
                $('#delete_attachment_form').attr('action','/admin/reports/15/attachment/{{$item->id}}/delete/'+item_id);
    ...
    <div class="main-page">
        <h2 class="title">
            Редактирование страницы Видеоархивов
        </h2>
        <form method="post" action="/admin/reports/15/edit" >
            {{csrf_field()}}
            <div class="blank-page">
                ...
                <ul id="myTabs" class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="">
                        <a href="#add_documents" id="add_documents-tab" role="tab" data-toggle="tab" aria-controls="add_documents" aria-expanded="false">Список Видео</a>
                    </li>
                    <li role="presentation" class="">
                ...
                <div id="myTabContent" class="tab-content scrollbar1">
                    ...
                    <div role="tabpanel" class="tab-pane fade " id="add_documents" aria-labelledby="add_documents-tab">
                        ...
                        <hr>
                        <div >
                            <a style="display:block;margin-bottom:22px;" href="{{route('create_attachment',['parent' => $item,'type' => 15])}}"> <button type="button" class="btn btn-pri btn-success"><i class="fa fa-plus" aria-hidden="true"></i>Добавить вложение </button></a>
                            <div class="blank-page widget-shadow scroll">
                                <table class="table table-bordered">
                                    <thead>
                                    <tr> <th>Порядок сортировки </th>Ссылка на ютуб<th>Заголовок</th> <th>Дата</th>  <th> ОПЕРАЦИИ </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($item->attachments()->orderBy('sort_order')->get() as $attachment)
                                        <tr class="success">
                                            ...
                                            <td>{{$attachment->show_date}}</td>
                                            <td><a href="{{route('edit_attachment',['parent' => $item,'item'=>$attachment->id,'type'=>15])}}"><i class="glyphicon glyphicon-edit"></i></a><a class="delete_main_accr" data-toggle="modal" data-target="#delete-element-modal"  itemid="{{$attachment->id}}" href="#"><i class="glyphicon glyphicon-remove"></i></a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
