...
@section('content')
    <script type="text/javascript">
        $(document).ready(function(){
            $('.delete_main_accr').on('click',function(){
                ...
                $('#delete_exist_form').attr('action','/admin/reports/17/attachment/delete/'+item_id);
            });
    ...
    <div class="main-page">
        <h2 class="title">
            Редактирование страницы "Студенты"
        </h2>
        <form method="post" action="/admin/reports/17/edit" >
            {{csrf_field()}}
            <div class="blank-page">
                ...
                <ul id="myTabs" class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="">
                        <a href="#add_documents" id="add_documents-tab" role="tab" data-toggle="tab" aria-controls="add_documents" aria-expanded="false">Список Документов</a>
                    </li>
                    <li role="presentation" class="">
