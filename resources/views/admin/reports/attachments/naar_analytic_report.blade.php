...
@section('content')
    ...
    <div class="blank-page">
        <h2 class="title1">
            @if(empty($item->id))
                Добавление аналитического отчета к странице "Аналитические отчеты НААР"
            @else
                Редактирование аналитического отчета  страницы "Аналитические отчеты НААР"
            @endif
        </h2>
        <script src="{{ asset("vendor/laravel-filemanager/js/stand-alone-button.js") }}"></script>
        <form method="post" @if(empty($item->id))action="/admin/reports/12/attachment/{{$parent->id}}/create" @else action="/admin/reports/12/attachment/{{$parent->id}}/{{$item->id}}" @endif>
            {{csrf_field()}}
            <div class="blank-page">
                @if (session('status'))
                ...
                <div id="myTabContent" class="tab-content scrollbar1">
                    <div role="tabpanel" class="tab-pane fade active in" id="main" aria-labelledby="main-tab">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-btn">
                                  <a data-input="file" class="btn btn-primary popup_selector">
                                     <i class="fa fa-picture-o"></i> Выберите документ
                                    </a>
                                </span>
