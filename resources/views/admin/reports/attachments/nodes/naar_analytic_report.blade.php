...
@section('content')
    ...
    <div class="blank-page">
        <h2 class="title1">
            @if(!empty($item->id))
                Редактирование перевода на язык "{{$lang}}" аналитического отчета "{{$parent->title}}"  страницы "Аналитические отчеты НААР"
            @else
                Добавление перевода на язык "{{$lang}}" аналитического отчета "{{$parent->title}}"  страницы "Аналитические отчеты НААР"
            @endif
