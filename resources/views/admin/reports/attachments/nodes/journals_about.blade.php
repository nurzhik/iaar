...
@section('content')
    ...
    <div class="blank-page">
        <h2 class="title1">
            @if(!empty($item->id))
                Редактирование перевода на язык "{{$lang}}" журнала "{{$parent->title}}"  к странице "О Журнале"
            @else
                Добавление перевода на язык "{{$lang}}" журнала "{{$parent->title}}"  страницы "О Журнале"
            @endif
