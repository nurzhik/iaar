...
@section('content')
    <script type="text/javascript">
        $(document).ready(function(){
            $('.delete_main_accr').on('click',function(){
                ...
                $('#delete_exist_form').attr('action','/admin/reports/15/attachment/delete/'+item_id);
            });
    ...
    <div class="main-page">
        <h2 class="title">
            Редактирование перевода на язык '{{$lang}}' страницы Видеоархивов
        </h2>
        <form method="post" action="/admin/reports/nodes/15/{{$lang}}/edit" >
            {{csrf_field()}}
