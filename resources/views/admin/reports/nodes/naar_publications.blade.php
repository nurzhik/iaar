...
@section('content')
    <script type="text/javascript">
        $(document).ready(function(){
            $('.delete_main_accr').on('click',function(){
                ...
                $('#delete_exist_form').attr('action','/admin/reports/14/attachment/delete/'+item_id);
            });
    ...
    <div class="main-page">
        <h2 class="title">
            Редактирование страницы перевода на  язык {{$lang}} публикаций НААР
        </h2>
        <form method="post" action="/admin/reports/nodes/14/{{$lang}}/edit" >
            {{csrf_field()}}
