...
@section('content')
    ...
    <div class="blank-page">
        ...
        <form method="post" action="/admin/log/registry-update">
            {{csrf_field()}}
            <div class="blank-page">
                @if (session('status'))
                ...
                <div id="myTabContent" class="tab-content scrollbar1">
                    <div role="tabpanel" class="tab-pane fade active in" id="main" aria-labelledby="main-tab">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="date" class="form-control"  value="{{$item->date}}" name="date" >
                        </div>


                        <div class="form-group">
                            <label for="is_blocked">Автоматическое обновление?</label>
                            <input type="checkbox"   class="tgl tgl-light" {{$item->is_blocked ? 'checked' : ''}} name="is_blocked" id="is_blocked">
                            <label class="tgl-btn"   for="is_blocked"></label>
                        </div>
