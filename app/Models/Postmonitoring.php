 ...
 */
class Postmonitoring extends Model
{

    protected $table ='postmonitorings';

    public function updateFix()
    {
        $this->content = str_replace('https://iaar.iaar.agency','',$this->text);
    ...
    {
        return $this->hasMany(Tab::class,'page_id');
    }
    public function files()
    {
        return $this->hasMany(File::class,'page_id');
    }

    public function nodes()
    {
        return $this->hasMany(PostmonitoringNode::class,'parent_id');
    }
