...
class RatingCouncilPageController extends Controller
{
    ...
    public function editPage()
    {
        ...
        return view('admin.reports.journals.rating_council',[
            'item' => $item
        ]);
    }
    ...
    public function createMember()
    {
        ...
        return view('admin.reports.journals.rating_board_member',[
            'item' => $item,
            'parent' => $parent
        ]);
